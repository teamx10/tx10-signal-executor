...
7) knowledge-user-defaults.md  
   - User-confirmed defaults to avoid repeated clarifications (e.g., BTCUSDT linear, “max loss” definition, USD=USDT 1:1, profit in USDT by TP).  
...
1) Read screenshot(s). Extract required fields with full certainty.  
   - Apply defaults from knowledge-default-assumptions.md **and** knowledge-user-defaults.md to avoid unnecessary clarifications.
